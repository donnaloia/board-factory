...
class CellStatus:
    """Per-asset approval status used to color and route a cell."""
...
def _resolve_position(layout: dict, ref: str) -> tuple[int, int, int, int]:
    """Mirror of schemas.catalog.BoardSpacesSpec.resolve_position for raw dicts."""
...
def _cell_svg(
    *,
    ...
    return (
        ...
        f'data-asset-id="{safe_id}" data-category="{category}" '
