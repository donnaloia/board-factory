...
def test_cell_status_with_live_png(seeded_board, test_user, isolated_repo):
    from services import cells as svc_cells
    ...
    assert f"/users/{test_user.username}/board-games/{seeded_board.id}/asset/live/spaces/corner_tl.png" in status.approved_url
