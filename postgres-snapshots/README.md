...
```bash
git add postgres-snapshots/postgres_dev.sql
...
- Remove `postgres_dev.sql` from git: `git rm --cached postgres-snapshots/postgres_dev.sql` (and delete or keep locally).
